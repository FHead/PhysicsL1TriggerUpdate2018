...
./Execute \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_001.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_002.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_003.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_004.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_005.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_006.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_007.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_008.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1Muon_009.pdf

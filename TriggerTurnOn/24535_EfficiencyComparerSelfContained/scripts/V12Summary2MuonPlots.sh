...
./Execute \
   ...
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_001.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_002.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_003.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_004.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_005.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_006.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_007.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_008.pdf
./Execute \
   --label "GMT TkMuon","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV12},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V12_Summary2Muon_009.pdf

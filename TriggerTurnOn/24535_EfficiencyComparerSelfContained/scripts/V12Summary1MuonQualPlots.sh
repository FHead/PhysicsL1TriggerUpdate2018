...
./Execute \
   ...
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_001.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_002.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_003.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_004.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_005.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_006.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_007.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_008.pdf
./Execute \
   --label "GMT Muon","STA Muon (L1 TDR)","STA Muon (HLT TDR)" \
   --file ${DYLLV12GMT},${DYLLV10},${DYLLV12} \
   ...
   --color -2,-5,-4 \
   --Davignon ${Davignon} --output Plots/V12_Summary1MuonQual_009.pdf

...
./Execute \
   ...
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_001.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_002.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_003.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_004.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_005.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_006.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_007.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_008.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_009.pdf
./Execute \
   --label "EG Electron","TkElectron","TkIsoElectron","TkIsoPhoton" \
   --file ${DYLLV12},${DYLLV12},${DYLLV12},${HGGV12} \
   ...
   --color -1,-3,-4,-5 \
   --Davignon ${Davignon} --output Plots/V12_EG_010.pdf

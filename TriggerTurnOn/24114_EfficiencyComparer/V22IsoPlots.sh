...
./Execute \
   ...
   --Davignon ${Davignon} --legendx 0.35 --legendy 0.20 --line 0.982 --output Plots/V22Iso_001.pdf
./Execute \
   ...
   --Davignon ${Davignon} --legendx 0.45 --legendy 0.15 --line 0.946 --output Plots/V22Iso_002.pdf
./Execute \
   --label "TkPhoton (Barrel)","TkPhoton (Endcap)" \
   --file ${HGGV22},${HGGV22} \
   ...
   --Davignon ${Davignon} --legendx 0.45 --legendy 0.15 --line 0.946 --output Plots/V22Iso_003.pdf
./Execute \
   --label "TkPhoton (PT > 10)","TkPhoton (PT > 20)","TkPhoton (PT > 40)" \
   --file ${HGGV22},${HGGV22},${HGGV22} \
   ...
   --Davignon ${Davignon} --legendx 0.35 --legendy 0.65 --line 0.00 --logy true --output Plots/V22Iso_004.pdf

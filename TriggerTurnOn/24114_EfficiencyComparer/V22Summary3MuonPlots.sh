...
./Execute \
   ...
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_001.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_002.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_003.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_004.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
...
./Execute \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_006.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_007.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_008.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)","TkMuonStub (L1 TDR)","TkMuon (L1 TDR)","TkMuon (HLT TDR)" \
   --file ${DYLLV22},${DYLLV22},${DYLLV10},${DYLLV10},${DYLLV12} \
   ...
   --color 609,-2,-5,-4,-1 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_009.pdf
./Execute \
   ...
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_010.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)" \
   --file ${DYLLV22},${DYLLV22} \
   ...
   --title ";Gen. #eta;Matching efficiency (p_{T} > 15 GeV)" --xmin -3.0 --xmax 3.0 --ymin 0.00 --ymax 1.10 --rebin 1 \
   --color 609,-2 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_011.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)" \
   --file ${DYLLV22},${DYLLV22} \
   ...
   --title ";Gen. p_{T} (GeV);Matching efficiency (barrel)" --xmin 0 --xmax 150 --ymin 0.00 --ymax 1.10 --rebin 2 \
   --color 609,-2 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_012.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)" \
   --file ${DYLLV22},${DYLLV22} \
   ...
   --title ";Gen. p_{T} (GeV);Matching efficiency (overlap)" --xmin 0 --xmax 150 --ymin 0.00 --ymax 1.10 --rebin 2 \
   --color 609,-2 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_014.pdf
./Execute \
   --label "GMT TkMuon","GMT TkMuon (NStub>1)" \
   --file ${DYLLV22},${DYLLV22} \
   ...
   --title ";Gen. p_{T} (GeV);Matching efficiency (endcap)" --xmin 0 --xmax 150 --ymin 0.00 --ymax 1.10 --rebin 2 \
   --color 609,-2 \
   --Davignon ${Davignon} --output Plots/V22_Summary3Muon_015.pdf

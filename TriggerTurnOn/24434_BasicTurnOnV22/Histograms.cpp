   ...
   vector<double> &thresholds, string label)
{
   ...
   for(int iT = 0; iT < (int)Thresholds.size(); iT++)
   {
      ...
      HL1PT.push_back(                New(Label, "L1PT",                 Cut, ";PT;#",  ptbin,  ptmin,  ptmax));
      HL1PTEta15.push_back(           New(Label, "L1PTEta15",            Cut, ";PT;#",  ptbin,  ptmin,  ptmax));
      HL1PTEtaLarge.push_back(        New(Label, "L1PTEtaLarge",         Cut, ";PT;#",  ptbin,  ptmin,  ptmax));
      ...
      HEtaPT2to5.push_back(           New(Label, "EtaPT2to5",            Cut, ";Eta;#", Etabin, Etamin, Etamax));
      HEtaPT3to5.push_back(           New(Label, "EtaPT3to5",            Cut, ";Eta;#", Etabin, Etamin, Etamax));
      HEtaPT3to6.push_back(           New(Label, "EtaPT3to6",            Cut, ";Eta;#", Etabin, Etamin, Etamax));
      ...
      HDXYPT15.push_back(             New(Label, "DXYPT15",              Cut, ";DXY;#", dxybin, dxymin, dxymax));
      HDXYPT20.push_back(             New(Label, "DXYPT20",              Cut, ";DXY;#", dxybin, dxymin, dxymax));
      HDXYPT30.push_back(             New(Label, "DXYPT30",              Cut, ";DXY;#", dxybin, dxymin, dxymax));
...
void Histograms::Fill(double check, double pt, double eta, double iso, double dr, bool Mode, int Region, double dxy)
{
   for(int i = 0; i < (int)Thresholds.size(); i++)
   {
      ...
      if(HL1PT[i] != NULL)                                           HL1PT[i]->Fill(check);
      if(HL1PTEta15[i] != NULL && Region == 0)                       HL1PTEta15[i]->Fill(check);
      if(HL1PTEtaLarge[i] != NULL && Region == 1)                    HL1PTEtaLarge[i]->Fill(check);
      ...
      if(HEtaPT2to5[i] != NULL && pt > 2 && pt < 5)                  HEtaPT2to5[i]->Fill(eta);
      if(HEtaPT3to5[i] != NULL && pt > 3 && pt < 5)                  HEtaPT3to5[i]->Fill(eta);
      if(HEtaPT3to6[i] != NULL && pt > 3 && pt < 6)                  HEtaPT3to6[i]->Fill(eta);
      ...
      if(HDXYPT15[i] != NULL && pt > 15)                             HDXYPT15[i]->Fill(dxy);
      if(HDXYPT20[i] != NULL && pt > 20)                             HDXYPT20[i]->Fill(dxy);
      if(HDXYPT30[i] != NULL && pt > 30)                             HDXYPT30[i]->Fill(dxy);
   }
}
...
void Histograms::Write(TDirectory *Directory)
{
   ...
   Write(HL1PT,                 Directory);
   Write(HL1PTEta15,            Directory);
   Write(HL1PTEtaLarge,         Directory);
   ...
   Write(HEtaPT2to5,            Directory);
   Write(HEtaPT3to5,            Directory);
   Write(HEtaPT3to6,            Directory);
   ...
   Write(HDXYPT15,              Directory);
   Write(HDXYPT20,              Directory);
   Write(HDXYPT30,              Directory);
}

...
./ExecutePlot \
   ...
   --Color -4,-6 \
   --Davignon true --OutputBase Plots/V22_TauBarrel
...
./ExecutePlot \
   ...
   --Color -4,-6 \
   --Davignon true --OutputBase Plots/V22_TauEndcap
...
./ExecutePlot \
   ...
   --MaxX 80 --MaxY 150 --Threshold "Barrel 90%" \
   --Color -4,-1,-2,-3 \
   --Davignon true --OutputBase Plots/V22_NNTauBarrel
...
./ExecutePlot \
   ...
   --MaxX 80 --MaxY 150 --Threshold "Endcap 90%" \
   --Color -4,-1,-2,-3 \
   --Davignon true --OutputBase Plots/V22_NNTauEndcap
...
./ExecutePlot \
   ...
   --MaxX 80 --MaxY 150 --Threshold "Barrel 90%" \
   --Color -4,-2 \
   --Davignon true --OutputBase Plots/V22_NNTau1VtxBarrel
...
./ExecutePlot \
   ...
   --MaxX 80 --MaxY 150 --Threshold "Endcap 90%" \
   --Color -4,-2 \
   --Davignon true --OutputBase Plots/V22_NNTau1VtxEndcap
